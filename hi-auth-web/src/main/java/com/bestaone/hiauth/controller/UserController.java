...
public class UserController implements UserApi {
	...
	@Override
	@GetMapping
	public ApiResponse<PageVo<UserVo>> query(Integer pageNum, Integer pageSize, String name, String clientId) {
		Page pageinfo = PageHelper.startPage(pageNum, pageSize);
		List<User> users = userService.findByName(name);
		if (clientId != null){
			List<String> userId = testService.UserIdByClientId(clientId);
			List<User> clientUsers = testService.findByUserIds(userId);
			users.removeAll(clientUsers);
